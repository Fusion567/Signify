...
export default function SignUpPage() {
  ...
  const handleEmailSignup = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem(
        "signify_session",
        JSON.stringify({ email, name, provider: "email" })
      );
      router.push("/dashboard");
    }, 1500);
  };
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[40%] bg-[#4bb5b9] p-12 text-white relative">
        ...
        <div className="flex flex-col items-center flex-grow justify-center mt-12 mb-8">
          ...
          <h2 className="text-3xl font-bold text-center leading-snug mb-8">
            Speed Up Turnaround Time<br />With Easy eSignatures
          </h2>
          ...
          <div className="text-center px-4">
            ...
            <p className="font-bold text-sm">Carolina Miranda</p>
            <p className="text-sm opacity-90">Cultivating Capital</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col pt-12 px-8 lg:px-24">
        ...
        <div className="flex justify-center items-center mb-16 gap-2">
          <div className="w-3 h-3 rounded-full bg-[#4bb5b9]"></div>
        ...
        <div className="max-w-md mx-auto w-full">
          <h1 className="text-[28px] font-semibold text-[#4bb5b9] text-center mb-10">
            Sign Up to SignWell for Free
          </h1>
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 mb-6 font-medium text-gray-700 bg-white border-gray-300 hover:bg-gray-50 flex items-center justify-center gap-3 relative overflow-hidden"
          ...
          <form onSubmit={handleEmailSignup} className="space-y-6">
            <div>
              ...
              <Input 
                ...
                className="h-12 border-[#4bb5b9] focus-visible:ring-[#4bb5b9] rounded-sm placeholder:text-gray-400"
              />
            </div>
            ...
            <div>
              <label className="block text-[15px] font-semibold text-gray-700 mb-2">
                Password <span className="text-gray-500 font-normal text-sm">(at least 8 characters, 1 uppercase and 1 special character)</span>
              </label>
              <Input 
                type="password" 
            ...
            <div className="flex items-center justify-between pt-2">
              <Link href="/login" className="text-sm text-[#4bb5b9] hover:underline font-medium">
